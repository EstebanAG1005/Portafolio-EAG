            ...
            <div className='container'>
                ...
                <div className='content'>
                    <div className='card'>
                        ...
                        <a className='button1' href='https://juanelcaballo.club/20591/Lab06/Memoria.html' target = "_blank" >Ver Sitio</a>
                    </div>
                    <div className='card'>
                        ...
                        <a className='button1' href='https://elevationworship-copy-page.netlify.app/' target = "_blank" >Ver Sitio</a>
                    ...
                    <div className='card'>
                        ...
                        <a className='button1' href='https://juanelcaballo.club/20591/build/index.html' target = "_blank" >Ver Sitio</a>
                    </div>
                    <div className='card'>
                        ...
                        <a className='button1' href='https://juanelcaballo.club/20591/Laberinto/dist/index.html' target = "_blank" >Ver Sitio</a>
                    </div>
