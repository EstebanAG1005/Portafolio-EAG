            ...
            <div className='container'>
                ...
                <div className='content'>
                    <div className='card'>
                        ...
                        <p><span>Desarrollado por</span></p>
                        <p>Esteban Aldana Guerra</p>
                        <a className='button1' href='https://juanelcaballo.club/20591/Lab06/Memoria.html'>Ver Sitio</a>
                    </div>
                    <div className='card'>
                        ...
                        <p><span>Desarrollado por</span></p>
                        <p>Esteban Aldana Guera</p>
                        <a className='button1' href='https://elevationworship-copy-page.netlify.app/'>Ver Sitio</a>
                    ...
                    <div className='card'>
                        ...
                        <p><span>Desarrollado por</span></p>
                        <p>Esteban Aldana Guera</p>
                        <a className='button1' href='https://juanelcaballo.club/20591/build/index.html'>Ver Sitio</a>
                    </div>
                    <div className='card'>
                        ...
                        <p><span>Desarrollado por</span></p>
                        <p>Esteban Aldana Guera</p>
                        <a className='button1' href='https://juanelcaballo.club/20591/Laberinto/dist/index.html'>Ver Sitio</a>
                    </div>
